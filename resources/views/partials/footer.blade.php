        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    <div class="footer-item">
                        <h4 class="text-white mb-4">QA Advance</h4>
                        <p class="text-white mb-3">Enhance your testing skills with QA advance. Your trusted platform for ISTQB preparation, providing comprehensive resources and guidance to help you excel in software quality assurance.</p>
                        <div class="d-flex">
                ...
                <div class="footer-item d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="text-white ms-2">
                            ...
                            <p class="mb-0">sohail@qaadvance.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href={{ url("qa/about") }} class="footer-link"> About Us</a>
                    ...
                    <a href={{ url("qa/contact") }} class="footer-link"> Contact Us</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    <div class="footer-item">
                        ...
                        <p class="text-white mb-3">Unlock your potential with QAadvance! Stay ahead in the world of software testing with the latest ISTQB preparation resources, tips, and updates. Your journey to mastering software quality assurance starts here—join our community today!</p>
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-white"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i> QA Advance </a>, All right reserved.</span>
            </div>
