    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                ...
                <button type="button" class="absolute right-0 p"  style="padding-right:1rem; margin-top:-2rem;"onclick="togglePasswordVisibility('password')">
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                ...
                <button type="button" class="absolute right-0" style="padding-right:1rem; margin-top:-2rem;" onclick="togglePasswordVisibility('password_confirmation')">
